      ...
      <div className="mt-12">
        ...
        <div className="mt-8 p-4 bg-muted rounded-lg">
          <p className="font-medium">
            {isRtl 
              ? 'ملاحظة: حاليًا، يتم تنفيذ كود JavaScript فقط في المتصفح. لتنفيذ لغات أخرى، سيتم إضافة دعم الخادم قريبًا.'
              : 'Note: Currently, only JavaScript code is executed in the browser. For other languages, server-side support will be added soon.'
            }
          </p>
        </div>
      </div>
