  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-blue-500 text-primary-foreground hover:bg-blue-500/90 border-blue-600 border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-blue-500 hover:bg-slate-100",
        secondary: "bg-cyan-500 text-primary-foreground hover:bg-cyan-500/90 border-cyan-600 border-b-4 active:border-b-0",
        ...
        sidebarOutline: "bg-blue-500/15 text-blue-500 border-blue-300 border-2 hover:bg-blue-500/20 transition-none"
      },
      size: {
